...
from accounts.views import SignUpView, InstructorSignUpView, StudentSignUpView, StudentProfileView, \
    InstructorProfileView, StudentProfileUpdateView, InstructorProfileUpdateView, CustomCSVView, BulkCreateFormComplete
...
urlpatterns = [
    ...
    path("accounts/signup/csv/", CustomCSVView.as_view(), name="custom-csv-view"),
    path("accounts/signup/csv/success", BulkCreateFormComplete.as_view(), name="custom-csv-view-success"),
    ...
    path('accounts/instructor/profile-update/', InstructorProfileUpdateView.as_view(),
         name='instructor_profile_update'),
